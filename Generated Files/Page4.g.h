...
namespace winrt::ControlSystem::implementation
{
    ...
    struct WINRT_IMPL_EMPTY_BASES Page4_base : implements<D, ControlSystem::Page4, composing, winrt::Microsoft::UI::Xaml::Controls::IPageOverrides, winrt::Microsoft::UI::Xaml::Controls::IControlOverrides, winrt::Microsoft::UI::Xaml::IFrameworkElementOverrides, winrt::Microsoft::UI::Xaml::IUIElementOverrides, I...>,
    ...
    {
        using base_type = Page4_base;
        using class_type = ControlSystem::Page4;
        using implements_type = typename Page4_base::implements_type;
...
namespace winrt::ControlSystem::factory_implementation
{
    ...
    struct WINRT_IMPL_EMPTY_BASES Page4T : implements<D, winrt::Windows::Foundation::IActivationFactory, I...>
    {
        using instance_type = ControlSystem::Page4;
...
#if defined(WINRT_FORCE_INCLUDE_PAGE4_XAML_G_H) || __has_include("Page4.xaml.g.h")

#include "Page4.xaml.g.h"
