...
namespace winrt::ControlSystem::implementation
{
    ...
    struct WINRT_IMPL_EMPTY_BASES Page2_base : implements<D, ControlSystem::Page2, composing, winrt::Microsoft::UI::Xaml::Controls::IPageOverrides, winrt::Microsoft::UI::Xaml::Controls::IControlOverrides, winrt::Microsoft::UI::Xaml::IFrameworkElementOverrides, winrt::Microsoft::UI::Xaml::IUIElementOverrides, I...>,
    ...
    {
        using base_type = Page2_base;
        using class_type = ControlSystem::Page2;
        using implements_type = typename Page2_base::implements_type;
...
namespace winrt::ControlSystem::factory_implementation
{
    ...
    struct WINRT_IMPL_EMPTY_BASES Page2T : implements<D, winrt::Windows::Foundation::IActivationFactory, I...>
    {
        using instance_type = ControlSystem::Page2;
...
#if defined(WINRT_FORCE_INCLUDE_PAGE2_XAML_G_H) || __has_include("Page2.xaml.g.h")

#include "Page2.xaml.g.h"
