...
namespace winrt::ControlSystem::implementation
{
    ...
    struct WINRT_IMPL_EMPTY_BASES Page3_base : implements<D, ControlSystem::Page3, composing, winrt::Microsoft::UI::Xaml::Controls::IPageOverrides, winrt::Microsoft::UI::Xaml::Controls::IControlOverrides, winrt::Microsoft::UI::Xaml::IFrameworkElementOverrides, winrt::Microsoft::UI::Xaml::IUIElementOverrides, I...>,
    ...
    {
        using base_type = Page3_base;
        using class_type = ControlSystem::Page3;
        using implements_type = typename Page3_base::implements_type;
...
namespace winrt::ControlSystem::factory_implementation
{
    ...
    struct WINRT_IMPL_EMPTY_BASES Page3T : implements<D, winrt::Windows::Foundation::IActivationFactory, I...>
    {
        using instance_type = ControlSystem::Page3;
...
#if defined(WINRT_FORCE_INCLUDE_PAGE3_XAML_G_H) || __has_include("Page3.xaml.g.h")

#include "Page3.xaml.g.h"
