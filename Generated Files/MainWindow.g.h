...
namespace winrt::ControlSystem::implementation
{
    ...
    struct WINRT_IMPL_EMPTY_BASES MainWindow_base : implements<D, ControlSystem::MainWindow, composing, I...>,
        ...
        impl::base<D, winrt::Microsoft::UI::Xaml::Window>
    {
        ...
        using class_type = ControlSystem::MainWindow;
        ...
        {
            return L"ControlSystem.MainWindow";
        }
        MainWindow_base()
        {
...
namespace winrt::ControlSystem::factory_implementation
{
    ...
    {
        using instance_type = ControlSystem::MainWindow;
