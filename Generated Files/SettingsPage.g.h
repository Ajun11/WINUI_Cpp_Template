...
namespace winrt::ControlSystem::implementation
{
    ...
    struct WINRT_IMPL_EMPTY_BASES SettingsPage_base : implements<D, ControlSystem::SettingsPage, composing, winrt::Microsoft::UI::Xaml::Controls::IPageOverrides, winrt::Microsoft::UI::Xaml::Controls::IControlOverrides, winrt::Microsoft::UI::Xaml::IFrameworkElementOverrides, winrt::Microsoft::UI::Xaml::IUIElementOverrides, I...>,
    ...
    {
        using base_type = SettingsPage_base;
        using class_type = ControlSystem::SettingsPage;
        using implements_type = typename SettingsPage_base::implements_type;
        ...
        {
            return L"ControlSystem.SettingsPage";
        }
        SettingsPage_base()
        {
...
namespace winrt::ControlSystem::factory_implementation
{
    ...
    struct WINRT_IMPL_EMPTY_BASES SettingsPageT : implements<D, winrt::Windows::Foundation::IActivationFactory, I...>
    {
        using instance_type = ControlSystem::SettingsPage;
...
#if defined(WINRT_FORCE_INCLUDE_SETTINGSPAGE_XAML_G_H) || __has_include("SettingsPage.xaml.g.h")
...
{
    template <typename D, typename... I>
    using SettingsPageT = SettingsPage_base<D, I...>;
}
