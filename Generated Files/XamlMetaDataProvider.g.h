...
namespace winrt::ControlSystem::implementation
{
    ...
    struct WINRT_IMPL_EMPTY_BASES XamlMetaDataProvider_base : implements<D, ControlSystem::XamlMetaDataProvider, I...>
    {
        using base_type = XamlMetaDataProvider_base;
        using class_type = ControlSystem::XamlMetaDataProvider;
        using implements_type = typename XamlMetaDataProvider_base::implements_type;
        using implements_type::implements_type;
        
        hstring GetRuntimeClassName() const
        {
            return L"ControlSystem.XamlMetaDataProvider";
        }
    };
}
namespace winrt::ControlSystem::factory_implementation
{
    ...
    {
        using instance_type = ControlSystem::XamlMetaDataProvider;
