...
namespace winrt::ControlSystem::implementation
{
    ...
    struct WINRT_IMPL_EMPTY_BASES ParameterSet_base : implements<D, ControlSystem::ParameterSet, composing, winrt::Microsoft::UI::Xaml::Controls::IPageOverrides, winrt::Microsoft::UI::Xaml::Controls::IControlOverrides, winrt::Microsoft::UI::Xaml::IFrameworkElementOverrides, winrt::Microsoft::UI::Xaml::IUIElementOverrides, I...>,
    ...
    {
        using base_type = ParameterSet_base;
        using class_type = ControlSystem::ParameterSet;
        using implements_type = typename ParameterSet_base::implements_type;
        ...
        {
            return L"ControlSystem.ParameterSet";
        }
        ParameterSet_base()
        {
...
namespace winrt::ControlSystem::factory_implementation
{
    ...
    struct WINRT_IMPL_EMPTY_BASES ParameterSetT : implements<D, winrt::Windows::Foundation::IActivationFactory, I...>
    {
        using instance_type = ControlSystem::ParameterSet;
...
#if defined(WINRT_FORCE_INCLUDE_PARAMETERSET_XAML_G_H) || __has_include("ParameterSet.xaml.g.h")

#include "ParameterSet.xaml.g.h"
...
{
    template <typename D, typename... I>
    using ParameterSetT = ParameterSet_base<D, I...>;
}
