...
namespace winrt::ControlSystem::implementation
{
    ...
    struct WINRT_IMPL_EMPTY_BASES Page1_base : implements<D, ControlSystem::Page1, composing, winrt::Microsoft::UI::Xaml::Controls::IPageOverrides, winrt::Microsoft::UI::Xaml::Controls::IControlOverrides, winrt::Microsoft::UI::Xaml::IFrameworkElementOverrides, winrt::Microsoft::UI::Xaml::IUIElementOverrides, I...>,
    ...
    {
        using base_type = Page1_base;
        using class_type = ControlSystem::Page1;
        using implements_type = typename Page1_base::implements_type;
...
namespace winrt::ControlSystem::factory_implementation
{
    ...
    struct WINRT_IMPL_EMPTY_BASES Page1T : implements<D, winrt::Windows::Foundation::IActivationFactory, I...>
    {
        using instance_type = ControlSystem::Page1;
...
#if defined(WINRT_FORCE_INCLUDE_PAGE1_XAML_G_H) || __has_include("Page1.xaml.g.h")

#include "Page1.xaml.g.h"
